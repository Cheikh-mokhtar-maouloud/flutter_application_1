...
//This is used to display the foreground notification
  ...
  static Future<void> sendAndroidNotification(
      String bady, String title, String id, String to) async {
    try {
      http.Response response = await http.post(
        ...
        headers: <String, String>{
          ...
          'Authorization':
              'key=AAAA_7bd7Vw:APA91bHhAA3rpdfQXAXvgfShg3vfiLiVlQPZn06EFXwDJejYiK4YKWRwjYXT8rEwu10voQGR2Rrzuzb3ynesuSIA8haJ7gRQk1ccerJfLJF0XkOb9T46H6j1AngHXODc_k6obic-JpLZ',
        },
        body: jsonEncode(
          <String, dynamic>{
